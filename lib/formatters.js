...
// Currency symbol for a holding's own display, based on the same .NS/.BO
// suffix convention used throughout the app (lib/twelveData.js,
// lib/symbolResolver.js) — used instead of the live quote's `currency`
// field so a holding still shows the right symbol even while its price is
// temporarily unavailable.
export function currencySymbolFor(symbol) {
